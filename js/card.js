...
(() => {
  ...
  const onCreateCard = () => {
    ...
    const cardListElement = window.pin.mapBooking.querySelector(`.map__filters-container`);
    ...
    window.card = {
      isPinEvent: (element, pin) => {
        element.addEventListener(`click`, () => {
          ...
          window.pin.mapBooking.insertBefore(popupElement, cardListElement);
